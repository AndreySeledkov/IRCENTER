...
public class MUtil {
    ...
    private static final Pattern LOGIN_PATTERN = Pattern.compile("[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}");
    ...
    public static boolean isValidLogin(String login) {
        ...
        if (matcher.find()) {
            return (matcher.start() == 0) && (matcher.end() == login.length());
        }
        return false;
    }
...
//        return floatToString(r, 2);
    ...
    public static String replaceHTMLtextReturn(String text) {
        if (text == null) {
            return null;
        }
        text = replaceAll(text, "&amp;", "&");
