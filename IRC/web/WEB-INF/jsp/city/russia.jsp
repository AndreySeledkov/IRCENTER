    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/ru.jpg" alt="" style="margin-right: 10px; margin-bottom: 10px;">
        </p>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td>Россия, Кировская</td>
                  <td>Киров</td>
                  <td> </td>
                  <td> </td>
                  <td>Матвеев Виктор</td>
                  <td>063-624-11-88</td>
              </tr>
              <tr>
                  <td>Россия, Москововская</td>
                  <td>Орехово-Зуево</td>
                  <td> </td>
                  <td> </td>
                  <td>Матвеев Виктор</td>
