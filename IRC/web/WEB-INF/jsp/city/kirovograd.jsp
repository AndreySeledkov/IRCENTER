    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/10.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        <h2>ИНФОРМАЦИЯ ПО ОТПРАВЛЕНИЮ АВТОБУСОВ КИРОВОГРАД</h2>
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Кировоградская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Бобринец, Кировоград</td>
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Кировоградская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Кировоград</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сойникова Наталья</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0676314460</td>
              </tr>
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Кировоградская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Устиновка</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'></td>
