    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/18.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        <h2>ИНФОРМАЦИЯ ПО ОТПРАВЛЕНИЮ АВТОБУСОВ СУМЫ</h2>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сумская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Рамны</td>
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сумская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сумы</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сумская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Шостка</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Шатара Сергей</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>067-63-31-982</td>
