    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/11.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Крым</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Керчь</td>
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Крым</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Симферополь</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Кинотеатр "Симферополь" (арка)</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Мельник Руслан</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0667443395</td>
              </tr>
          </table>
      </td>
    </tr>
