    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/24.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Черниговская </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Нежин</td>
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Черниговская </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Прилуки</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>марченко-матвеев</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>063-624-11-88</td>
              </tr>
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Черниговская </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Чернигов</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Валентина Кольба</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>093-045-00-42</td>
