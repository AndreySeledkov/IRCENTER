    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img src="/static/img/20.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Харьковская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Харьков</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>7.00</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>м. Университет, памятник Ленина</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Биличенко Светлана</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0503039596; 0638327367</td>
              </tr>
          </table>
      </td>
    </tr>
