    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/7.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        <h2> </h2>
        ...
        <p>
            <table class="city_table" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Запорожская</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Бердянск</td>
                ...
                <tr>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Запорожская</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Днепрорудный</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сойникова Наталья</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0676314460</td>
                ...
                <tr>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Запорожская</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Запорожье</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>6.00</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>пл.Фестивальная</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сойникова Наталья</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0676314460</td>
                </tr>
                <tr>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Запорожская</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Энергодар</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'> </td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Сойникова Наталья</td>
                    <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0676314460</td>
