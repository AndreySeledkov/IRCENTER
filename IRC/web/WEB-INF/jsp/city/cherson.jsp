    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/21.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        ...
        <p>
          ...
          <table class="city_table" cellspacing="0" cellpadding="0">
              ...
              <tr>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Херсонская</td>
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>Херсон</td>
                  ...
                  <td style='border-bottom:solid 1px #000000; border-right:solid 1px #000000;'>0676314460, 0634073299</td>
              </tr>
          </table>
      </td>
    </tr>
