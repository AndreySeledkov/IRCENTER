    ...
    <tr>
      <td valign="top">
        <p style="float:left;margin-bottom: 10px;margin-right:10px;">
          <img style="float: left;" src="/static/img/stories/goroda/15.jpg" alt="" style="margin-right: 10px;margin-bottom: 10px;">
        </p>
        <h2></h2>
        ...
        <p>
          <span style="font-size: 9pt; font-family: Arial, sans-serif;">
             Наталья (093) 015- 74- 62,  772- 33- 25
            <o:p></o:p>
          </span>
        </p>
        <p>
          <span style="font-size: 9pt; font-family: Arial, sans-serif;">
            Куликово Поле (район ж/д вокзала со стороны обкома), отправление в 8.00
            <o:p></o:p>
          </span>
        </p>
      </td>
