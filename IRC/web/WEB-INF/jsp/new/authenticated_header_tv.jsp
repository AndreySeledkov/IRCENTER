...
%>
<div id="profile_pad_menu" onMouseOver="show_pad2_menu('profile_pad_menu', 'profile_pad_button')"
     onMouseOut="hide_pad2_menu('profile_pad_menu', 'profile_pad_button')">
    ...
    <div id="header">
        ...
        <div id="header_bottom">
            <div id="header_menu">
                ...
                <a id="media_button" href="/tv_online" class="link select" onMouseOver="show_pad_menu('media', 'media_button')" onMouseOut="hide_pad_menu('media', 'media_button')"><span class="l">&nbsp;</span>Телевидение<span class="r">&nbsp;</span></a>
