...
<div id="content_video_out">
    <div id="content_video">
        <div id="video_content_main">
            <div class="video_box">
                ...
                <c:if test="${link==null}">
                    ${minutesToGodList.get(0).getLink()}
                </c:if>
    ...
    <div id="content">
        <div class="video_main_content">
            <div class="arch_of_minist">5 минут для Бога</div>
            <div class="arrow_to_down">&nbsp;</div>
            <div class="video_bottom_text">
                <img width="300" style="float:right;"
                     data-thumb="http://img.youtube.com/vi/${minutesToGod.getYoutubeId()}/0.jpg"
                     alt="Значок видео"
                     src="http://img.youtube.com/vi/${minutesToGod.getYoutubeId()}/0.jpg"
                     data-group-key="thumb-group-0">
                ${minutesToGod.getText()}
            </div>

            <c:forEach items="${minutesToGodList}" var="varMinutesToGod">
                <div class="topic m0">
                    <a href="/minutes_to_god?page=${page}&link_id=${varMinutesToGod.getId()}"
                       class="group_element">${varMinutesToGod.getTitle()}</a>

                    <div class="topic_block">
                        <a href="/minutes_to_god?link_id=${varMinutesToGod.getId()}">
                            <img width="165" style="float:right;"
                                 data-thumb="http://img.youtube.com/vi/${varMinutesToGod.getYoutubeId()}/0.jpg"
                                 alt="Значок видео"
                                 src="http://img.youtube.com/vi/${varMinutesToGod.getYoutubeId()}/0.jpg"
                                 data-group-key="thumb-group-0">
                        </a>

                        <p>${varMinutesToGod.getText()}</p>
                    </div>
                    <!-- /topic_block -->
                </div>
                <div class="read_next mb20">
                    <div class="fl_left ml10" style="font-size: 11px;">
                        ...
                        <span style="margin-left: 5px;color: #000000;">${varMinutesToGod.getCountViews()}</span>
                    </div>
                    <div class="read_next_right">
                        ...
                        <fmt:formatDate dateStyle="short" value="${varMinutesToGod.getCreatedDate()}"/>
                    </div>
                    <!-- /read_next_right -->
                </div>
            </c:forEach>
