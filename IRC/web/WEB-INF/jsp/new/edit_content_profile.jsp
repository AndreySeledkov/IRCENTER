...
//                    $('#pedit_filters a').click(function () {
//                        alert('YRA!!!!');
//                        history.pushState({path:this.path}, '', this.href);
//                        return false;
//                    });
//                    $(window).bind('popstate', function () {
//                        // $('#list3 a.header_in_link').slideTo(location.pathname);
//                        alert('Yra1!');
...
//                });
        ...
        <div class="button_bg">
            <button class="button_save_form" name="saveMainInfo" onclick="ProfilerEditor.">Сохранить</button>
        </div>
    </form:form>
</c:when>
<c:when test="${userContacts != null}">
    <form:form action="" modelAttribute="userContacts" method="post">
        <div class="edit_block">
            ...
            <br>
            <label class="option_name" for="_skype">Skype:</label>
            <form:input path="skype" id="_skype" class="option_value" value=""/>
            <br>
            <label class="option_name" for="own_phone">Личный сайт:</label>
            <form:input path="ownSite" id="own_phone" class="option_value" value=""/>
            <br>
        </div>
        <div class="button_bg">
            <button type="submit" class="button_save_form" name="saveUserContacts">Сохранить</button>
        </div>
    </form:form>
</c:when>
<c:when test="${userInterests != null}">
    <form:form action="" modelAttribute="userInterests" method="post">
        <div class="edit_block">
            <label class="option_name" for="_activities">Деятельность:</label>
            <form:textarea path="activities" id="_activities" class="option_value" value=""/>
            <br>
            <label class="option_name" for="_interests">Интересы:</label>
            <form:textarea path="interests" id="_interests" class="option_value" value=""/>
            <br>
            <label class="option_name" for="_books">Любимые книги:</label>
            <form:textarea path="books" id="_books" class="option_value" value=""/>
            <br>
            <label class="option_name" for="_about">О себе:</label>
            <form:textarea path="about" id="_about" class="option_value" value=""/>
            <br>
        </div>
        <div class="button_bg">
            <button type="submit" class="button_save_form" name="saveUserInterests">Сохранить</button>
        </div>
    </form:form>
</c:when>
</c:choose>
...
<%--<div class="button_bg">--%>
<%--<button type="submit" class="button_save_form">Сохранить</button>--%>
<%--</div>--%>
