...
<div id="content_video_out">
    <div id="content_video">
        ...
        <div id="video_right_sidebar">
            ...
            <jsp:include page="5_minutes_to_god.jsp"/>
...
<div id="content">
    <div class="video_main_content">
        <div class="arch_of_minist">Телепередачи</div>
        ...
        <div id="navig_menu_tv" class="navig_menu_tv">
            <div class="links">
                <c:if test="${type==0}">
                    <a href="/tv?type=1" onclick="show_navig('navig_menu_tv', this, 'dnepropetrovsk');" class="link">Днепропетровские</a>
                    <a href="/tv?type=0" onclick="show_navig('navig_menu_tv', this, 'kiev');" class="link select">Киевские</a>
                </c:if>

                <c:if test="${type==1}">
                    <a href="/tv?type=1" onclick="show_navig('navig_menu_tv', this, 'dnepropetrovsk');"
                       class="link select">Днепропетровские</a>
                    <a href="/tv?type=0" onclick="show_navig('navig_menu_tv', this, 'kiev');" class="link">Киевские</a>
                </c:if>
            </div>

            <c:forEach items="${tvList}" var="tv" varStatus="varStatus">
                <a href="/tv?type=${type}&page=${page}&id=${tv.getId()}" class="video_element">
                    <div class="img_abs">
                        <img width="165"
                             data-thumb="http://img.youtube.com/vi/${tv.getYoutubeId()}/0.jpg"
                             alt="Значок видео"
                             src="http://img.youtube.com/vi/${tv.getYoutubeId()}/0.jpg"
                             data-group-key="thumb-group-0">
                    </div>
                    <span class="title">${tv.getTitle()}</span>
                </a><!-- /video_element -->
            </c:forEach>
