        ...
        <div class="list_element_center">
            ...
            <ul class="fl_right">
                ...
                <li><a href="/messages?section=outbox"
                       onclick="return rightSideUpdateMessagesModal('/messages?section=outbox','outbox')"
                       class="select">Отправленые</a></li>
            </ul>
        </div>
    </div>
    <div class="profile_right_column_content">
        <div class="profile_messages_header">
            <span class="messages_counter">Вы отправили ${privateMessagesCount} сообщений </span>
