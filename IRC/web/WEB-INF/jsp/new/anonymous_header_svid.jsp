    ...
    <div id="header">
        ...
        <div id="header_bottom">
            <div id="header_menu">
                ...
                <a id="svidet_button" href="/text_evidence" class="link select" onMouseOver="show_pad_menu('svidet', 'svidet_button')" onMouseOut="hide_pad_menu('svidet', 'svidet_button')"><span class="l">&nbsp;</span>Свидетельства<span class="r">&nbsp;</span></a>
