    ...
    <div id="header">
        <div id="header_top">
            ...
            <div id="header_top_right">
                <a href="/profile" id="profile_pad_button" class="header_center_line_pad_menu_button mt12" onMouseOver="show_pad2_menu('profile_pad_menu', 'profile_pad_button')" onMouseOut="hide_pad2_menu('profile_pad_menu', 'profile_pad_button')">
        ...
        <div id="header_bottom">
            <div id="header_menu">
                <a href="/" class="link select">Главная</a>
                ...
                <a href="javascript:void(0)" class="link select"><span class="l">&nbsp;</span>Обучение<span class="r">&nbsp;</span></a>
