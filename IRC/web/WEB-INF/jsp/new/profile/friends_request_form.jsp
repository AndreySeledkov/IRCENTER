...
<div class="profile_right_column_content">
    <div class="profile_messages_header">
        <span class="messages_counter">У Вас ${friendsCount} заявки в друзья</span>
            ...
            <div class="friend silver_bg">
                ...
                <div class="friend_operations">
                    <a href="javascript:void(0);"
                       onclick="return rightSideUpdateMessageModal('/friends?section=all_requests',${user.userId})"
                       class="friend_operation">Написать сообщение</a>
                    <a href="javascript:void(0);" class="friend_operation"
                       onclick="deleteRequestFriend(${user.userId})">Удалить заявку</a>
                    <a href="javascript:void(0);" class="friend_operation" onclick="addToFriend(${user.userId})">Подтвердить
                        заявку</a>
