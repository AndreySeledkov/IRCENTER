...
<div class="profile_right_column_header_elements">
    <div class="list_element_center">
        <ul class="fl_left">
            <li><a href="javascript:void(0)" onclick="return rightSideUpdateModal('/friends?section=all')">Все
                друзья</a></li>
            <li><a href="javascript:void(0)" onclick="return rightSideUpdateModal('/friends?section=online')"
                   class="select">Друзья
                on-line</a>
            </li>
            <li><a href="javascript:void(0)" onclick="return rightSideUpdateModal('/friends?section=all_requests')">Заявки
                в
                друзья</a></li>
...
<div class="profile_right_column_content">
    <div class="profile_messages_header">
        <span class="messages_counter">У Вас ${friendsCount} друга on-line</span>
            ...
            <div class="friend silver_bg">
                <a href="/profile?id=<c:out value="${user.userId}"/>" class="avatar">
                    <img src="/img/${user.userId}/th_${user.userId}.jpg" alt=""/>
                        <%--<img src="/static/img/tmp46.jpg" alt=""/>--%>
                </a>
