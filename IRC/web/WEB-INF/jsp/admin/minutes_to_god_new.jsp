...
//        function sendNewMinutesToGod() {
//            $.post("/admin/minutes_to_god/add_new", { defaultImage:$('#default_image').val(), title:$('#title').val(), text:CKEDITOR.instances['area3'].getData(), link:$('#link').val()},
//                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="minutes_to_god_form_new.jsp"/>
