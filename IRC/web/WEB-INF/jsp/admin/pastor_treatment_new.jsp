...
<head>
    ...
    <script type="text/javascript">
        function sendNewPastorTreatment() {
            $.post("/admin/pastor/add_new", { defaultImage:$('#default_image').val(), text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="pastor_treatment_form_new.jsp"/>
