            ...
            <div id="wpbody-content">
                <div class="wrap">
                    ...
                    <div id="poststuff" class="metabox-holder has-right-sidebar">
                                                ...
                                                <div id="minor-publishing-actions">
                                                    <div id="save-action">
                                                        <input type="button" name="save" id="save-post"
                                                               ...
                                                               onclick="action.updateNews(${news.getId()})"/>
                                                    </div>
                                                ...
                                                <div id="category-adder" class="wp-hidden-children">
                                                    ...
                                                    <p id="category-add" class="category-add ">
                                                        ...
                                                        <input type="text" name="newcategory" id="newcategory"
                                                               ...
                                                               value="Название новой рубрики" tabindex="3"
                                                               aria-required="true">
                                                        <label class="screen-reader-text" for="newcategory_parent">
                                                            Родительская
                                                            рубрика: </label>
                                                        <form:select path="chapterId" cssClass="postform"
                                                                     tabindex="3">
                                                            <form:option value="-1"
                        ...
                        <form:form action="./save_news" method="post" modelAttribute="news">
                            <div id="post-body">
                                <div id="post-body-content">
                                    <div id="titlediv">
                                        ...
                                        <form:form action="" method="" modelAttribute="newsParts">
                                            Рубрика - <form:select path="id">
                                            <form:options items="${parts}" itemValue="id" itemLabel="name"/>
                                        </form:select>
                                        </form:form>
                                        <div>Дата начала новости - <input class="date" id="date_start"
                                                                          value="${news.getStartDate()}"></div>
                                            <%--<div>Дата конца новости - <input class="date" id="date_stop"></div>--%>
                                        <div>Номер картинки по умолчанию - №<input type="text" id="image"
                                                                                   value="${news.getImageId()}">
                                        </div>
                                        <div class="inside">
