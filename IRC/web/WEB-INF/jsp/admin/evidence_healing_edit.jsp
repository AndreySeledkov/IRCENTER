...
<head>
    ...
    <script type="text/javascript">
        function sendEditEvidenceHealing() {
            $.post("/admin/evidence_healing/submit_edit_evidence_healing", {id:${evidenceHealing.getId()},defaultImage:$('#default_image').val(),text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="evidence_healing_edit_form.jsp"/>
