...
<head>
    ...
    <script type="text/javascript">
        <%--function sendEditSecretSpiritWorld() {--%>
            <%--$.post("/admin/secret_spiritual_world/submit_edit_secret_spiritual_world", {id:${secretSpiritualWorld.getId()},text:CKEDITOR.instances['area3'].getData(),title:$('#title').val(),link:$('#link').val(), defaultImage:$('#default_image').val()},--%>
                    <%--function (response) {--%>
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="secret_spiritual_world_edit_form.jsp"/>
