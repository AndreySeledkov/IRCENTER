...
<head>
    ...
    <script type="text/javascript">
        function sendNewTextEvidence() {
            $.post("/admin/text_evidence/add_new", { defaultImage:$('#default_image').val(), title:$('#title').val(), text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="text_evidence_new_form.jsp"/>
