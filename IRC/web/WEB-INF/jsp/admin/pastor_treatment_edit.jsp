...
<head>
    ...
    <script type="text/javascript">
        function sendEditPastorTreatment() {
            $.post("/admin/pastor/submit_edit_pastor_treatment", {id:${pastorTreatment.getId()}, text:CKEDITOR.instances['area3'].getData(), defaultImage:$('#default_image').val()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="pastor_treatment_edit_form.jsp"/>
