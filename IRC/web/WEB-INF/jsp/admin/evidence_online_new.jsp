...
<head>
    ...
    <script type="text/javascript">
//        function sendNewEvidenceOnline() {
//            $.post("/admin/evidence_online/add_new", { title:$('#title').val(), text:CKEDITOR.instances['area3'].getData()},
//                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="evidence_online_form_new.jsp"/>
