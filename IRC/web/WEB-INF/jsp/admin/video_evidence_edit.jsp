...
<head>
    ...
    <script type="text/javascript">
        <%--function sendEditVideoEvidence() {--%>
            <%--$.post("/admin/video_evidence/submit_edit_video_evidence", {id:${videoEvidence.getId()}, defaultImage:$('#default_image').val(), title:$('#title').val(), link:$('#link').val()},--%>
                    <%--function (response) {--%>
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="video_evidence_edit_form.jsp"/>
