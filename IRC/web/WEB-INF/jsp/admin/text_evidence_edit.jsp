...
<head>
    ...
    <script type="text/javascript">
        function sendEditTextEvidence() {
            $.post("/admin/text_evidence/submit_edit_text_evidence", {id:${textEvidence.getId()}, defaultImage:$('#default_image').val(), title:$('#title').val(), text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="text_evidence_edit_form.jsp"/>
