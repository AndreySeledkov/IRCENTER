    ...
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <div id="wpbody-content">
                <div class="wrap">
                    <h2>Фотографии</h2><br/>
                    <form:form id="post" class="MultiFile-intercepted" enctype="multipart/form-data" method="post" action="/admin/media_add">
                        Заголовок - <input type="text" name="title"><br/>
                        <input type="file" name="picture" id="picture"> <input type="submit" value="Загрузить">
                    </form:form>
                </div>
                <div class="clear">
                </div>
