...
<head>
    ...
    <script type="text/javascript">
        function sendNewEvidenceHealing() {
            $.post("/admin/evidence_healing/add_new", { defaultImage:$('#default_image').val(), text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="evidence_healing_form_new.jsp"/>
