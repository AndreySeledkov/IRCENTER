...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendNewVideoEvidence() {
//            $.post("/admin/video_evidence/add_new", { defaultImage:$('#default_image').val(), title:$('#title').val(), link:$('#link').val()},
//                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="video_evidence_form_new.jsp"/>
