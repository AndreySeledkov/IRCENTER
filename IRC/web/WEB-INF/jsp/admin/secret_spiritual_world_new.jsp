...
//        function sendNewSecretSpiritWorld() {
//            $.post("/admin/secret_spiritual_world/add_new", { defaultImage:$('#default_image').val(), title:$('#title').val(), text:CKEDITOR.instances['area3'].getData(), link:$('#link').val()},
//                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="secret_spiritual_world_form_new.jsp"/>
