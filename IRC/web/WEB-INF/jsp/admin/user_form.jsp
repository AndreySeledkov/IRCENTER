...
<div id="wpbody-content">
    <div class="wrap">
        ...
        <input type="text" name="search_user" size="30" tabindex="1" value="" id="search_user">
        <input type="button" onclick="searchUser()" value="Поиск">
        ...
        <table class="wp-list-table widefat fixed users" cellspacing="0">
            ...
            <c:forEach items="${profiles}" var="profile" varStatus="varStatus">
                <tr id="user-1" class="alternate">

                    <td class="username column-username">
                        <strong>
                            <a href="javascript:void(0)">${profile.getUserId()}</a>
                        </strong>
                        <br>
                        ...
                        <div class="row-actions">
				              <span class="edit">
				                <a href="javascript:void(0)">Изменить</a> | <a
                                      href="/admin/users/${profile.getUserId()}"
                    ...
                    <td>
                        <c:forEach items="${profile.getAuthorities()}" var="auth">
                            ${auth}
                        </c:forEach>
                    </td>
                    <td>
