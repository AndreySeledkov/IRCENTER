...
<head>
    ...
    <script type="text/javascript">
        function sendEditMinutesToGod() {
            $.post("/admin/minutes_to_god/submit_edit_minutes_to_god", {id:${minutesToGod.getId()},text:CKEDITOR.instances['area3'].getData(),title:$('#title').val(),link:$('#link').val(), defaultImage:$('#default_image').val()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="minutes_to_god_edit_form.jsp"/>
