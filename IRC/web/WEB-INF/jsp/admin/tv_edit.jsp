...
<head>
    ...
    <script type="text/javascript">
        <%--function sendEditTv() {--%>
            <%--$.post("/admin/tv/submit_edit_tv", {id:${tv.getId()}, link:$('#link').val(), title:$('#title').val(), tvType:$('#type').val(), defaultImage:$('#default_image').val()},--%>
                    <%--function (response) {--%>
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="tv_edit_form.jsp"/>
