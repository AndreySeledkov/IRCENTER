...
<head>
    ...
    <script type="text/javascript">
        function sendEditEvidenceOnline() {
            $.post("/admin/evidence_online/submit_edit_evidence_online", {id:${onlineEvidence.getId()}, title:$('#title').val(), text:CKEDITOR.instances['area3'].getData()},
                    function (response) {
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="evidence_online_edit_form.jsp"/>
