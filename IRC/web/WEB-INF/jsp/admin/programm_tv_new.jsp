    ...
    <script type="text/javascript">
        ...
        function sendNewProgrammTv() {
            ...
            if (xmlhttp) {
                ...
                xmlhttp.open("GET", "/admin/programm_tv/add_new?title=" + title.value + "&date=" + date.value + "&type=" + type.value, true);
...
<div id="wpwrap">
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <jsp:include page="programm_tv_form_new.jsp"/>
