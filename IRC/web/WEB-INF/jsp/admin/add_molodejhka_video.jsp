    ...
    <div id="wpcontent">
        ...
        <div id="wpbody">
            ...
            <div id="wpbody-content">
                ...
                <form:form action="/admin/add_molodejhka_v">
                    <div>Ссылка - <input id="link" name="link"></div>
                    <div>Заголовок - <input id="description" name="description"></div>
                    <div>Описание - <input id="text" name="text"></div>
